...
//CreatePost create an post based on the http request and return it
...
//GetPost return a post based on uid
...
//UpdatePost update post info in database
...
//DeletePost delete a post based on uid
